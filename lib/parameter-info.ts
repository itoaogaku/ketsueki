 ...
 * overstated.
 *
 * highSymptoms/lowSymptoms are a brief, general list of what abnormal
 * values in that direction can cause - omitted for a parameter whose
 * REFERENCE_RANGES entry has no bound in that direction (e.g. ビタミンD
 * has no upper bound tracked here), and both are omitted for the two
 * specimen-quality flags (A-LY, 乳び) that don't have a numeric range at
 * all.
 *
...
export interface ParameterInfo {
  ...
  /** Brief - what a high value can cause/indicate. */
  highSymptoms?: string;
  /** Brief - what a low value can cause/indicate. */
  lowSymptoms?: string;
  references: string[];
}
...
export const PARAMETER_INFO: Record<string, ParameterInfo> = {
  "フェリチン(Ferritin) (※フェリチン精密)": {
    ...
    highSymptoms: "鉄の摂りすぎや炎症・肝疾患などで上昇することがあるが、それ自体の自覚症状は乏しいことが多い。",
    lowSymptoms: "疲労感・息切れ・集中力低下・持久力低下など、鉄欠乏性貧血の初期症状につながりやすい。",
    references: [
  ...
  "Hb（ヘモグロビン量）": {
    ...
    highSymptoms: "脱水や高地順化などで上昇しうる。血液の粘性が増し、まれに頭痛・めまいを伴う。",
    lowSymptoms: "動悸・息切れ・強い疲労感・めまい・持久力低下など、貧血に典型的な症状につながる。",
    references: [
  ...
  "ヘマトクリット値（Hematocrit)": {
    ...
    highSymptoms: "脱水による血液濃縮や赤血球産生の亢進で上昇。血液粘性が増し、頭痛・めまいを伴うことがある。",
    lowSymptoms: "貧血や血漿量増加（トレーニング適応）を反映し、疲労感・息切れにつながりやすい。",
    references: [
      "Schumacher YO, et al. Hematological indices and iron status in athletes. Int J Sports Med. 2002.",
  ...
  "Fe（血清鉄）": {
    ...
    highSymptoms: "鉄剤の過剰摂取や鉄過剰症などで上昇しうるが、自覚症状は乏しいことが多い。",
    lowSymptoms: "鉄欠乏の初期サインのひとつで、疲労感・集中力低下につながることがある（単独での判断は難しい）。",
    references: [
      "Peeling P, et al. Iron Deficiency in Athletes. Curr Sports Med Rep. 2017.",
      "Sim M, et al. Iron considerations for the athlete: a narrative review. Eur J Appl Physiol. 2019.",
    ],
  ...
  "UIBC(不飽和鉄結合能)": {
    ...
    highSymptoms: "鉄欠乏が進んでいるサインで、倦怠感・疲労感を伴うことがある。",
    lowSymptoms: "鉄過剰や炎症状態などで低下することがある。",
  ...
  "TIBC(総鉄結合能)": {
    ...
    highSymptoms: "鉄欠乏に対する体の代償反応で、倦怠感・疲労感を伴うことがある。",
    lowSymptoms: "炎症・感染・低栄養状態などで低下することがある。",
    references: ["Sim M, et al. Iron considerations for the athlete: a narrative review. Eur J Appl Physiol. 2019."],
  },
  "TSAT(トランスフェリン飽和度）": {
    whatItMeasures:
    ...
    highSymptoms: "鉄過剰状態を示唆することがあるが、通常は無症状。",
    lowSymptoms: "鉄欠乏性赤血球造血のサインで、疲労感・持久力低下につながりやすい。",
    references: [
      "Sim M, et al. Iron considerations for the athlete: a narrative review. Eur J Appl Physiol. 2019.",
      "Peeling P, et al. Iron Deficiency in Athletes. Curr Sports Med Rep. 2017.",
    ],
  ...
  "MCV（平均赤血球容積）": {
    ...
    highSymptoms: "ビタミンB12・葉酸不足などによる大球性貧血で上昇し、疲労感やしびれを伴うことがある。",
    lowSymptoms: "鉄欠乏による小球性貧血のサインで、疲労感・息切れにつながりやすい。",
  ...
  "MCH（平均赤血球血色素量）": {
    ...
    highSymptoms: "大球性貧血などで上昇しうるが、単独での意味は乏しい。",
    lowSymptoms: "鉄欠乏性貧血で低下し、疲労感・息切れにつながりやすい。",
    references: ["Eichner ER. Sports anemia, iron supplements, and blood doping. Med Sci Sports Exerc. 1992."],
  },
  "MCHC（平均赤血球血色素濃度）": {
    ...
    highSymptoms: "遺伝性球状赤血球症など特殊な状態を除けば稀で、単独での意味は乏しい。",
    lowSymptoms: "鉄欠乏性貧血の進行で低下し、疲労感・息切れにつながりやすい。",
    references: ["Eichner ER. Sports anemia, iron supplements, and blood doping. Med Sci Sports Exerc. 1992."],
  },
  網赤血球数: {
    whatItMeasures:
    ...
    highSymptoms: "造血が活発な状態（高地順応、出血・溶血後の代償反応など）を示す。",
    lowSymptoms: "骨髄の反応が乏しい状態を示唆し、貧血があるのに網赤血球が増えない場合は材料不足（鉄など）や骨髄機能低下が疑われる。",
    references: [
  ...
  "CK（クレアチンキナーゼ）": {
    ...
    highSymptoms:
      "強い筋肉痛・筋の張りや腫脹・脱力感につながる。著しい高値では褐色〜赤褐色の尿（ミオグロビン尿）を伴う運動誘発性横紋筋融解症のサインのことがあり、その場合は医療機関の受診が必要。",
    lowSymptoms: "特に問題となる症状はなく、臨床的な意味は乏しい。",
    references: [
  ...
  "BUN（尿素窒素）": {
    ...
    highSymptoms: "脱水・高タンパク食・筋分解の亢進などで上昇し、のどの渇きや倦怠感を伴うことがある。",
    lowSymptoms: "タンパク質摂取不足や肝機能低下で低下することがある。",
    references: [
  ...
  "コルチゾール（Cortisol）": {
    ...
    highSymptoms: "強いストレスや慢性的な過負荷状態で上昇しやすく、疲労感・睡眠の質低下・免疫低下と関連しうる。",
    lowSymptoms: "オーバートレーニングに伴う副腎の反応低下や慢性疲労状態でみられることがある。",
    references: [
  ...
  "GOT/AST": {
    ...
    highSymptoms: "運動後の筋損傷や肝機能異常で上昇。運動後の一過性上昇自体は無症状のことが多い。",
    lowSymptoms: "臨床的な意味は乏しい。",
    references: [
  ...
  "Cr（クレアチ二ン）": {
    ...
    highSymptoms: "脱水や運動誘発性の一過性腎機能低下で上昇。尿量減少・むくみを伴う場合は要注意。",
    lowSymptoms: "筋肉量の少なさを反映することが多く、通常は問題にならない。",
    references: [
  ...
  "K（カリウム）": {
    ...
    highSymptoms: "脱力感・しびれ、高度になると不整脈のリスクがあり緊急性が高い。",
    lowSymptoms: "脱力感・筋けいれん、高度になると不整脈のリスクがあり緊急性が高い。",
  ...
  "Na（血清ナトリウム）": {
    ...
    highSymptoms: "脱水による高ナトリウム血症で、強いのどの渇き・倦怠感、高度では意識障害。",
    lowSymptoms:
      "運動関連低ナトリウム血症（EAH）でみられ、頭痛・吐き気・むくみ、重度では脳浮腫による意識障害・けいれんのリスク。",
    references: [
  ...
  "Cl（血清クロール）": {
    ...
    highSymptoms: "脱水や過換気などで上昇しうるが、単独での自覚症状は乏しい。",
    lowSymptoms: "嘔吐・下痢などの体液喪失で低下しうる。",
  ...
  尿酸: {
    ...
    highSymptoms: "慢性的に続くと将来的な痛風発作（関節の激痛・腫脹、特に足の親指の付け根）や尿路結石のリスクにつながる。",
    lowSymptoms: "通常は問題となる症状は乏しい。",
  ...
  "ALP(アルカリホスファターゼ）": {
    ...
    highSymptoms: "成長期の生理的高値のほか、骨代謝の亢進（骨折治癒過程を含む）や肝疾患で上昇することがある。",
    lowSymptoms: "亜鉛欠乏や栄養不足などで低下することがある。",
    references: [
  ...
  "Ca(血清カルシウム)": {
    ...
    highSymptoms: "倦怠感・便秘・食欲不振などにつながり、高度になると意識障害を伴うことがある。",
    lowSymptoms: "手足のしびれ・筋けいれん（テタニー）につながりやすく、高度になると不整脈のリスクがある。",
    references: [
      "Barrack MT, et al. Physiological Factors of Female Runners With and Without Stress Fracture Histories. Sports Health. 2020.",
  ...
  "LDH（乳酸脱水素酵素）": {
    ...
    highSymptoms: "筋損傷・溶血・肝障害などで上昇。運動後の一過性上昇自体は無症状のことが多い。",
    lowSymptoms: "臨床的な意味は乏しい。",
    references: [
      "Brancaccio P, et al. Biochemical markers of muscular damage. Clin Chem Lab Med. 2010.",
  ...
  総蛋白: {
    ...
    highSymptoms: "脱水による血液濃縮を反映することが多く、単独での自覚症状は乏しい。",
    lowSymptoms: "栄養・エネルギー摂取不足のサインで、疲労感・回復の遅れにつながりうる。",
    references: [
  ...
  テストステロン: {
    ...
    highSymptoms: "通常は問題となる症状は乏しい（過度に高い場合は外因性摂取などの関与を疑う）。",
    lowSymptoms: "回復の遅れ・疲労感・性欲低下・骨密度低下につながり、慢性化すると疲労骨折リスクの上昇につながりうる。",
    references: [
  ...
  亜鉛: {
    ...
    highSymptoms: "サプリメントの過剰摂取などで上昇しうる。銅の吸収阻害による貧血のリスクにつながることがある。",
    lowSymptoms: "免疫力低下（風邪をひきやすい）・味覚低下・創傷治癒の遅れ・筋力低下につながりうる。",
    references: [
  ...
  ビタミンD: {
    ...
    lowSymptoms: "骨密度低下・疲労骨折リスクの上昇、筋力低下、易感染性につながりうる。",
    references: [
  ...
  白血球数: {
    ...
    highSymptoms: "感染症・炎症、あるいは激しい運動直後の一過性反応で上昇する。",
    lowSymptoms: "感染症にかかりやすくなる可能性がある（持久系アスリートでは生理的な低値のこともある）。",
    references: [
  ...
  赤血球数: {
    ...
    highSymptoms: "脱水や高地順応などで上昇することがある。",
    lowSymptoms: "貧血のサインで、疲労感・息切れにつながりやすい。",
  ...
  血小板数: {
    ...
    highSymptoms: "運動後の一過性反応のほか、まれに血栓のリスクと関連しうる。",
    lowSymptoms: "あざができやすい・出血が止まりにくいなど、出血しやすくなる可能性がある。",
  ...
  Neutro: {
    ...
    highSymptoms: "感染症・炎症、あるいは激しい運動直後の一過性反応で上昇する。",
    lowSymptoms: "感染症にかかりやすくなる可能性がある。",
  ...
  Baso: {
    ...
    highSymptoms: "アレルギー反応などで上昇することがある。",
    lowSymptoms: "臨床的な意味は乏しい。",
  ...
  Eosino: {
    ...
    highSymptoms: "アレルギー疾患・寄生虫感染などで上昇することがある。",
    lowSymptoms: "臨床的な意味は乏しい。",
    references: ["一般臨床検査医学における白血球分画の標準的知見。"],
  },
  Lympho: {
    ...
    highSymptoms: "ウイルス感染などで上昇することがある。",
    lowSymptoms: "運動誘発性の一時的な免疫抑制状態や、感染症にかかりやすい状態と関連しうる。",
    references: [
      "Gleeson M. Immune function in sport and exercise. J Appl Physiol. 2007.",
  ...
  Mono: {
    ...
    highSymptoms: "感染症・炎症からの回復期などで上昇することがある。",
    lowSymptoms: "臨床的な意味は乏しい。",
    references: ["Gleeson M. Immune function in sport and exercise. J Appl Physiol. 2007."],
  },
  "A-LY": {
  ...
  トランスフェリン: {
    ...
    highSymptoms: "鉄欠乏に対する体の代償反応で、倦怠感・疲労感を伴うことがある。",
    lowSymptoms: "炎症や低栄養状態で低下することがある。",
    references: ["Sim M, et al. Iron considerations for the athlete: a narrative review. Eur J Appl Physiol. 2019."],
  },
};
